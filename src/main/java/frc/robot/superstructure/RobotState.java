...
public enum RobotState {
    ...
    POST_L2(ArmPosition.TILTED_BRANCH_CORAL_SCORE_POST, ElevatorStates.L2_FOLLOWTHROUGH, IntakeState.DEFAULT, GripperStates.RELEASE_CORAL),
    ...
    POST_L3(ArmPosition.TILTED_BRANCH_CORAL_SCORE_POST, ElevatorStates.L3_FOLLOWTHROUGH, IntakeState.DEFAULT, GripperStates.RELEASE_CORAL),
    ...
    PRE_L1(ArmPosition.UPWARDS, ElevatorStates.DEFAULT_WITH_CORAL, IntakeState.L1_SCORE_PRE, GripperStates.VACENT),
    SCORE_L1(ArmPosition.UPWARDS, ElevatorStates.DEFAULT_WITH_CORAL, IntakeState.L1_SCORE, GripperStates.VACENT),
    ...
    // CORAL INTAKE
    FLOOR_INTAKE(ArmPosition.DOWNWARDS, ElevatorStates.DEFAULT_WITHOUT_GAME_PIECE, IntakeState.FLOOR_INTAKE, GripperStates.VACENT),
    FLOOR_INTAKE_WITH_ALGAE(ArmPosition.UPWARDS, ElevatorStates.DEFAULT_WITHOUT_GAME_PIECE, IntakeState.FLOOR_INTAKE, GripperStates.ALGAE),
    ...
    DEFAULT_WITH_CORAL(ArmPosition.UPWARDS, ElevatorStates.DEFAULT_WITH_CORAL, IntakeState.DEFAULT, GripperStates.VACENT),
    DEFAULT_WITH_ALGAE(ArmPosition.UPWARDS, ElevatorStates.DEFAULT_WITH_ALGAE, IntakeState.DEFAULT, GripperStates.VACENT),

    // HANDOFFS
    PRE_HANDOFF(ArmPosition.DOWNWARDS, ElevatorStates.PRE_HANDOFF, IntakeState.DEFAULT, GripperStates.INTAKE_CORAL),
    HANDOFF(ArmPosition.DOWNWARDS, ElevatorStates.HANDOFF, IntakeState.HANDOFF, GripperStates.INTAKE_CORAL),
    PRE_REVERSE_HANDOFF(ArmPosition.DOWNWARDS, ElevatorStates.HANDOFF, IntakeState.REVERSE_HANDOFF, GripperStates.CORAL),
    ...
    CENTERLIZE(ArmPosition.DOWNWARDS, ElevatorStates.DEFAULT_WITHOUT_GAME_PIECE, IntakeState.CENTERLIZE, GripperStates.VACENT);
